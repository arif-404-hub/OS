...
| **Architecture & DB Design** | System architecture recommendation (pattern, tiers, tech stack matrix, trade-offs, interactive Mermaid topology), 3NF-compliant database schema with Mermaid ER diagram, and production-ready multi-dialect SQL generation (PostgreSQL, MySQL, SQLite) with one-click copy and download. |
...
server/
  ...
  architecture.js   architecture recommendations, schema synthesis, and multi-dialect SQL
...
GET    /api/projects/:id/architecture      (?dialect=postgresql|mysql|sqlite)
